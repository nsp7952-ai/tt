...
## Инструкция для агентов по обновлению progress.md

После реализации каждой фичи или фикса **обязательно** обновляйте файл `progress.md` следующим образом:

### 1. Обновите секцию "В процессе разработки"
- Переместите выполненные задачи из "🟡 Активные задачи" в "✅ Завершенные задачи"
- Отметьте все подзадачи как выполненные `[x]`
- Добавьте краткое описание того, что было сделано

### 2. Обновите секцию "Планы"
- Обновите статус соответствующей фазы (например "✅ ЗАВЕРШЕНА")
- Отметьте все пункты фазы как выполненные

### 3. Добавьте секцию с деталями изменений
В конце файла добавьте новую секцию с подробным описанием изменений:

```markdown
## Изменения в [Название Фазы/Задачи]
...
**Добавлено:**
- Список новых функций/полей/классов

**Изменено:**
- Описание изменений в существующем коде

### Frontend изменения

#### Файл: `/путь/к/файлу.html`
...
#### Файл: `/путь/к/тестам.py`

**Добавлено N unit тестов:**
1. `test_name` - описание что тестирует
2. ...
...
pytest путь/к/тестам.py -v
```
```

### 4. Обновите дату и статус
В начале файла обновите:
- **Дата:** текущая дата в формате YYYY-MM-DD
- **Статус:** актуальный статус проекта

### 5. Проверьте чеклист
Убедитесь что выполнены все пункты из "Чеклиста для агентов":
- [x] Обновлен progress.md с деталями изменений
- [x] Добавлены/обновлены unit тесты
- [x] Проверено что изменения не ломают существующий функционал
- [x] Обновлена документация если нужно
- [x] UI соответствует спецификации в readme.md

---

**Важно:** Progress.md служит единственным источником истины о состоянии проекта для передачи контекста между агентами. Без его обновления задача считается невыполненной!
